...
def _runtime_payload_in_memory(art: PlannerArtifacts, cfg: PlannerConfig) -> dict[str, Any]:
    return build_runtime_payload_compact(
        ...
        raw_path_world_resampled=art.raw_path_world_resampled,
        raw_path_tangent_headings_rad=art.raw_path_tangent_headings_rad,
        raw_path_holonomic_rotations_rad=art.raw_path_holonomic_rotations_rad,
        raw_speed_profile=art.raw_speed_profile,
        final_geometry_source=art.final_geometry_source,
        summary=art.summary,
